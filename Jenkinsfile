pipeline {
    ...
    environment {
        EMAIL_TO = 'alaneighty88@gmail.com@gmail.com'
    }
    stages {
        ...
        stage ('5. Email Notification') {
            steps {
               mail bcc: 'alaneighty88@gmail.com@gmail.com', body: '''Terraform deployment is completed.
               Let me know if the changes look okay.
               Thanks,
               Dominion System Technologies,
              +1 (313) 413-1477''', cc: 'alaneighty88@gmail.com@gmail.com', from: '', replyTo: '', subject: 'Terraform Infra deployment completed!!!', to: 'alaneighty88@gmail.com@gmail.com'
